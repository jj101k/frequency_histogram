...
const EpwFields = (() => {
    ...
    const fields = [
        ...
        ConstrainedNumber("Visibility", { units: "km", missing: 9999 }),
        ConstrainedNumber("Ceiling Height", { units: "m", missing: 99999 }),
        PlainNumber("Present Weather Observation"),
        PlainNumber("Present Weather Codes"),
        ConstrainedNumber("Precipitable Water", { units: "mm", missing: 999 }),
